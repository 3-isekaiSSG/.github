...
| 🥨 김관호 <br> 이벤트 스토밍부터 API 개발까지 새로운것을 많이 경험해보는 프로젝트였습니다. <br> 앞서 mybatis로 개발하다 JPA를 사용한 첫 프로젝트였는데요. 프로젝트 초기에 개인적으로 공부해야할게 많았습니다. 팀원들이 코드리뷰를 통해서 작성한 API에 대해서 지속적으로 피드백 해주었고, 강사님과 FT님도 코드리뷰를 통해서 다듬어졌고 많이 발전할 수 있었습니다. 프로젝트를 마무리하는 시점에서 개인적으로 많이 성장했다고 느끼는데요. 프로젝트를 하며 좋은 팀원들에게 도움을 많이 받았던 것처럼 2차 프로젝트에는 팀원들에게 도움을 주고 더 성장할 수 있는 프로젝트가 되길 바랍니다.|
|:-------|
